...
<body class="antialiased">
    <div class="first-page">
        ...
        <div class="content">
            <div>
                ...
                <button class="btn-content">ỨNG TUYỂN NGAY</button>
            </div>
            <div>
                ...
                <button class="btn-content primary">ĐĂNG TUYỂN NGAY</button>
            </div>
        </div>
    </div>
    <div class="page-two">
        <h1 style="color: black;text-align: center;font-size: 30px;padding-top: 30px;font-weight: 700; ">VIỆC THEO NGÀNH NGHỀ</h1>
        <div class="type-job">
            <div class="img-cntt">
                <div class="one-tab">
    ...
    <div class="page-three">
        <h1 style="text-align: center;font-size: 30px;padding: 30px; ">KHÁCH HÀNG CỦA CHÚNG TÔI NÓI NHỮNG GÌ
        </h1>
        <div class="feedback">
            <div class="fb-1">
                <p></p>
